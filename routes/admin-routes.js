...
var playerData = require('../public/data/mlbdata');
...
module.exports = function(app, passport) {
    ...
    app.get('/mlbData', isLoggedIn, function(req, res) {
        ...
        for(var team in playerData.teams){
            ...
            var teamDatabaseId;
            Team.findOne({team_id : team_id},function(err,team){
             
                if(!team){ // Check if alerady team inserted
                    ...
                    teamDatabaseId = team._id; // Team Id from Database
                }
            });
